...
begin
  ...
  Label2.Text := 'Realizando Conexão com servidor de arquivos (FTP)...';
  ...
  begin
    ...
    begin
      Mensagens.Gerar_Mensagem_Simples
        ('Alguns Componentes de Conexão não foram encontrados! Reinstale o' +
        ' programa ou tente novamente mais tarde. O programa será encerrado automaticamente.');
  ...
  Label2.Text := 'Realizando Conexão com servidor de Banco de Dados (MySQL)...';
  Label2.Position.X := (436 - Label2.Width) / 2;
  Centro_Controle.Conectar_Servidor_MySQL;
  Label2.Text := 'Ativando módulos de serviços. Isto pode demorar um pouco...';
  Label2.Position.X := (436 - Label2.Width) / 2;
end;
