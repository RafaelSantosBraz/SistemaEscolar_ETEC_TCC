...
begin
  ...
  begin
    ...
    begin
      if Centro_Controle.FDQuery1.FieldByName('Cod_Curso').Value = Codigo_Curso_Anterior
      then
      begin
        Result := true;
      end
      ...
      begin
        try
          ...
          Codigo_Coordenador := Centro_Controle.FDQuery1.FieldByName
            ('Cod_Coordenador').Value;
          Centro_Controle.FDQuery1.SQL.Clear;
          Centro_Controle.FDQuery1.SQL.Append('update Curso set Nome_Curso = "'
            + Edit1.Text + '", Coordenador_Cod_Coordenador = ' +
            Codigo_Coordenador + ' where Cod_Curso = ' + Codigo_Curso_Anterior);
          Centro_Controle.Executar_Query('Curso', 1);
          Mensagens.Cadastrado_Com_Sucesso('Curso');
          Unit_Resultado_Pesquisa.Estado_Edicao := false;
          FRM_Cadastro_Curso.Hide;
          FRM_Principal.Show;
