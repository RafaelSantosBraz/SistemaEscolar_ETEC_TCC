...
begin
  ...
  begin
    Extensao_Salvar := 'Apresentação do Power Point';
  end
...
begin
  ...
  begin
    Edit1.TextPrompt := 'Máx. 40 caracteres';
    Edit1.MaxLength := 40;
  end;
    ...
    try
      ...
      begin
        try
          ...
          // Define os tipos de arquivos para cada extensão
          Extensao_Salvar_;
          // Faz o controle das extensões
          SaveDialog1.Filter := Extensao_Salvar + '|*' + Extensao_Arquivo;
          // Extensão para ser salvo o arquivo
          SaveDialog1.DefaultExt := Nova_Extensao_Arquivo;
          // Nome padrão
          // SaveDialog1.Title := Nome_Arquivo; {Não funciona}
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              Mensagens.Gerar_Mensagem_Simples
                ('Já existe um Arquivo com este Nome e Extensão.');
            end;
          end
          else
          begin
            Mensagens.Gerar_Mensagem_Simples
              ('O Nome do Arquivo de conter até 40 caracteres.');
...
begin
  ...
  begin
    ...
    // Identifica o Tipo do Arquivo de acordo com a Extensão
    ...
    begin
      Tipo_Arquivo := 'Apresentação Power Point';
    end
    ...
    begin
      Mensagens.Gerar_Mensagem_Simples
        ('Atenção, já existe um arquivo com Nome: "' + Nome_Final_Arquivo +
        '". Favor selecionar um arquivo válido.');
    ...
    try
      ...
      begin
        try
          ...
          Mensagens.Gerar_Mensagem_Simples
            ('Não foi possível excluir o Arquivo selecionado. Tente novamente mais tarde.');
        end;
      end;
    except
      begin
...
begin
  ...
  try
    ...
    then
    begin
      ComboBox1.Items.Append('Referente à: ' +
