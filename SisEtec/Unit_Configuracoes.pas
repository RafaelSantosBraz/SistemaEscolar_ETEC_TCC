...
uses
  ...
  FMX.Controls.Presentation, FMX.StdCtrls, FMX.TabControl, FMX.Effects,
...
procedure TFRM_Configuracoes.Image2Click(Sender: TObject);
begin
  FRM_Configuracoes.Hide;
  FRM_Principal.Show;
end;
