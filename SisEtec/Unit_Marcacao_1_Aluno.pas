...
begin
  if Mensagens.Fechar_Formulario('Cadastro Marcação 1 Aluno') = False then
  begin
    CanClose := False;
  end
  else
...
begin
  if Mensagens.Fechar_Formulario('Cadastro Marcação 1 Aluno') = True then
  begin
    Frm_Marcacao_1_Aluno.Hide;
    Frm_Cadastro_Eventos.Show;
  end;
end;
...
begin
  ...
  begin
    // código cadastrar e mensagem de aviso se cadastrou
  end;
end;
