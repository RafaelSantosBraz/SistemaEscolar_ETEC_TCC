...
type
  TCentro_Controle = class(TForm)
    ...
    procedure Cadastrar_Dados_Arquivo(Nome_Arquivo: String;
      Extensao_Arquivo: String; Tipo_Arquivo: String;
      Referencia_Arquivo: String; Codigo_Proprietario_Arquivo: String;
      Tipo_Proprietario_Arquivo: String; Nome_Emissor_Arquivo: String);
  private
...
uses Unit_Login, Unit_Principal, Unit_Cadastro_Coordenador,
  ...
  Unit_Cadastro_Eventos, Unit_Marcacao_Professores,
  Unit_Marcacao_Coordenadores, Unit_Marcacao_Administradores,
  Unit_Marcacao_Administradores_S, Unit_Pesquisa, Unit_Resultado_Pesquisa,
  Unit_Destinatario_Arquivos;

procedure TCentro_Controle.Cadastrar_Dados_Arquivo(Nome_Arquivo: String;
  Extensao_Arquivo: String; Tipo_Arquivo: String; Referencia_Arquivo: String;
  Codigo_Proprietario_Arquivo: String; Tipo_Proprietario_Arquivo: String;
  Nome_Emissor_Arquivo: String);
begin
  FDQuery1.SQL.Clear;
  FDQuery1.SQL.Append('insert into Arquivos (Nome_Arquivo, ' +
    'Extensao_Arquivo, Tipo_Arquivo, Referencia_Arquivo, Cod_Proprietario_Arquivo,'
    + ' Tipo_Proprietario_Arquivo, Nome_Emissor_Arquivo) values ("' +
    Nome_Arquivo + '", "' + Extensao_Arquivo + '", "' + Tipo_Arquivo + '", "' +
    Referencia_Arquivo + '", "' + Codigo_Proprietario_Arquivo + '", "' +
    Tipo_Proprietario_Arquivo + '", "' + Nome_Emissor_Arquivo + '"' + ')');
  Executar_Query('Arquivos', 1);
end;
...
begin
  ...
  Mensagens.Gerar_Mensagem_Simples(Unit_Central_Transferencia.Mensagem);
  Unit_Central_Transferencia.Formulario_Para_Retorno.Show;
end;
...
begin
  ...
  Unit_Destinatario_Arquivos.Estado_Menu := true;
end;
