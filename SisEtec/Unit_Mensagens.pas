...
type
  TMensagens = class(TForm)
    ...
    function Realizar_Novo_Cadastro(Nome_Tabela: String): Boolean;
    procedure Erro_Campo_Ja_Existente(Nome_Campo: String);
...
uses Unit_Controle, Unit_Login, Unit_Principal, Unit_Agenda;
...
procedure TMensagens.Erro_Campo_Ja_Existente(Nome_Campo: String);
begin
  Gerar_Mensagem_Simples('O "' + Nome_Campo +
    '" informado está sendo utilizado por outro ' +
    'usuário! Digite outro e tente novamente.');
end;
...
begin
  ...
  then
  begin
    Frm_Agenda.Timer2.Enabled := False;;
...
function TMensagens.Realizar_Novo_Cadastro(Nome_Tabela: String): Boolean;
begin
